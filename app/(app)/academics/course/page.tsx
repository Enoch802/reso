...
import { todayStr, DAY_NAMES } from "@/lib/dates";
...
function CourseInner() {
  ...
  const course = useLiveQuery(() => (isNaN(courseId) ? undefined : db.courses.get(courseId)), [courseId]);
